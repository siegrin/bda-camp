...
Kontribusi, baik itu dalam bentuk isu, saran fitur, atau *pull request*, sangat kami hargai! Lihat `CONTRIBUTING.md` untuk panduan lebih lanjut.

-   **[Panduan Berkontribusi](./.github/CONTRIBUTING.md)**
-   **[Laporkan Bug atau Ajukan Fitur](https://github.com/siegrin/bda-camp/issues)**
...
Jika Anda merasa proyek ini bermanfaat atau menarik, jangan ragu untuk memberikannya &#11088; di GitHub!
